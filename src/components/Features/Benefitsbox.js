    ...
    <div className="flex w-full items-center  mx-auto border-b pb-10 mb-10 border-gray-200 gap-4 lg:gap-0 lg:flex-row flex-col">
      {props.imagePos === "left" && (
        <div
          ...
          className="sm:w-48 sm:h-48 h-32 w-32 sm:mr-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0"
        >
      ...
      {props.imagePos === "right" && (
        <div className="sm:w-48  sm:h-48 h-32 w-32 sm:ml-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
          <img src={props.image} alt="feature-image" className="rounded-full" />
        </div>
      )}
    </div>
